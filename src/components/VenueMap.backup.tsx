...
export default function VenueMap({ selectedArea, onAreaSelect }: VenueMapProps) {
  ...
  const renderSVG = (className: string = "w-full h-auto") => (
    ...
    >
        ...
        {/* Bottom Sections (100s) - NOT CLICKABLE - Moved closer to stage */}
        <rect
          x="300"
          y="690"
          width="400"
          ...
          rx="5"
        />
        <text x="500" y="737" textAnchor="middle" fill="#6b7280" fontSize="16" className="text-[14px] sm:text-[16px]" fontWeight="bold">
          100's
        </text>

        {/* Lower Suites (201-205) - Fire Suites in Green - CLICKABLE - Shifted down 50% closer to 100's */}
        ...
        >
          ...
          <path
            d="M 160 635 L 155 565 L 180 530 L 245 550 L 265 585 L 260 645 Z"
            fill={getSectionFill('L')}
            stroke={getStrokeColor('L')}
            strokeWidth={getStrokeWidth('L')}
          />
          <text x="210" y="595" textAnchor="middle" fill="#000" fontSize="14" className="text-[12px] sm:text-[14px]" fontWeight="bold">
            201
          </text>

          {/* Section 202 - Elongated */}
          <path
            d="M 265 645 L 260 585 L 245 550 L 300 520 L 360 535 L 385 570 L 385 640 Z"
            fill={getSectionFill('L')}
            stroke={getStrokeColor('L')}
            strokeWidth={getStrokeWidth('L')}
          />
          <text x="320" y="595" textAnchor="middle" fill="#000" fontSize="14" className="text-[12px] sm:text-[14px]" fontWeight="bold">
            202
          </text>

          {/* Section 203 - Center - Large elongated rectangle */}
          <path
            d="M 385 640 L 385 495 L 615 495 L 615 640 Z"
            fill={getSectionFill('L')}
            stroke={getStrokeColor('L')}
            strokeWidth={getStrokeWidth('L')}
          />
          <text x="500" y="580" textAnchor="middle" fill="#000" fontSize="18" className="text-[16px] sm:text-[18px]" fontWeight="bold">
            203
          </text>

          {/* Section 204 - Elongated */}
          <path
            d="M 615 640 L 615 570 L 640 535 L 700 520 L 755 550 L 740 585 L 735 645 Z"
            fill={getSectionFill('L')}
            stroke={getStrokeColor('L')}
            strokeWidth={getStrokeWidth('L')}
          />
          <text x="680" y="595" textAnchor="middle" fill="#000" fontSize="14" className="text-[12px] sm:text-[14px]" fontWeight="bold">
            204
          </text>

          {/* Section 205 - Right - Elongated */}
          <path
            d="M 735 645 L 740 585 L 755 550 L 820 530 L 845 565 L 840 635 Z"
            fill={getSectionFill('L')}
            stroke={getStrokeColor('L')}
            strokeWidth={getStrokeWidth('L')}
          />
          <text x="790" y="595" textAnchor="middle" fill="#000" fontSize="14" className="text-[12px] sm:text-[14px]" fontWeight="bold">
            205
          </text>
        </g>
        ...
        {/* New Arched Section between Lawn and Terraces - Light Blue - 50 units tall with 50 unit gap */}
        <g fill="#ADD8E6" stroke="#87CEEB" strokeWidth="2" opacity="0.7">
          {/* Arched section with slight curve - 50 units tall, positioned with 50 unit gap from lawn */}
          <path
            d="M 140 130 L 140 80 Q 500 70 860 80 L 860 130 Q 500 120 140 130 Z"
          />
        </g>
        ...
        >
          <path
            d="M 110 70 L 110 30 L 420 15 L 420 55 Z"
            fill={getSectionFill('UNT')}
            stroke={getStrokeColor('UNT')}
            strokeWidth={getStrokeWidth('UNT')}
          />
          <text x="265" y="45" textAnchor="middle" fill="#000" fontSize="16" className="text-[14px] sm:text-[16px]" fontWeight="bold">
            NORTH TERRACE
          </text>
        </g>
        ...
        >
          <path
            d="M 890 70 L 890 30 L 580 15 L 580 55 Z"
            fill={getSectionFill('UST')}
            stroke={getStrokeColor('UST')}
            strokeWidth={getStrokeWidth('UST')}
          />
          <text x="735" y="45" textAnchor="middle" fill="#000" fontSize="16" className="text-[14px] sm:text-[16px]" fontWeight="bold">
            SOUTH TERRACE
          </text>
        </g>
      </svg>
